...
export const PUPPET_IMAGE_NUDGES = {
  torso: { nudgeX: -1, nudgeY: -57, nudgeRot: 0.0, nudgeScale: 1.0 },
  neck: { nudgeX: 0, nudgeY: 13, nudgeRot: 0.0, nudgeScale: 1.0 },
  head: { nudgeX: 0, nudgeY: 8, nudgeRot: 0.0, nudgeScale: 1.0 },
  upperArmL: { nudgeX: 2, nudgeY: 2, nudgeRot: -13.5, nudgeScale: 1.16 },
  upperArmR: { nudgeX: 0, nudgeY: 0, nudgeRot: 17.7, nudgeScale: 1.16 },
  lowerArmL: { nudgeX: 0, nudgeY: 0, nudgeRot: 0.0, nudgeScale: 1.0 },
  lowerArmR: { nudgeX: 0, nudgeY: 0, nudgeRot: 0.0, nudgeScale: 1.0 },
};
